...
public class JOverlay : Overlay {
    ...
    public override void SetupLocationMain() {
        ...
        SetupLocationMainText(XScoreText, checkAuto && JStatus.Settings.ShowXScore && VersionSafe.XScoreSupported && JStatus.Settings.XScorePotentialTextType != PotentialTextType.Potential, ref y);
        SetupLocationMainText(PotentialXScoreText, checkAuto && JStatus.Settings.ShowXScore && VersionSafe.XScoreSupported && JStatus.Settings.XScorePotentialTextType is PotentialTextType.Potential or PotentialTextType.Both, ref y);
