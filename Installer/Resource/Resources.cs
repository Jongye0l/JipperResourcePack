...
public class Resources {
    public static readonly Resources English = new() {
        ...
        MainScreen_Description2 = "An internet connection capable of accessing GitHub is required for installation.",
        MainScreen_Description3 = "Required systems such as UnityModManager and JALib may be automatically installed.",
        MainScreen_Description4 = "The Jipper Resource Pack only supports the latest older, default, beta, and alpha branches.\nIt may not work on other versions.",
        ...
        FinishScreen_Title_Install = "Jipper Resource Pack Installation Complete",
        FinishScreen_Title_Uninstall = "Jipper Resource Pack Uninstallation Complete",
        FinishScreen_Description_Install = "The Jipper Resource Pack installation is complete.\nClick the 'Exit' button to close the program.",
